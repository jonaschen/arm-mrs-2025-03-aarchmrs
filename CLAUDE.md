...
- **Phase 3 (H1–H8):** Active hardware engineering (code generation, GDB-MCP, QEMU, linter, multi-agent) — 🔲 In progress (H1 complete)
...
tools/
  ...
  eval_skill.py        # [DONE] Correctness evaluation (155 tests: 51 A64 + 16 T32/A32 + 18 GIC + 24 CoreSight + 14 PMU + 14 EX + 18 H1)
...
# Correctness evaluation (all 155 tests should pass)
...
Phase 3 builds a code-generation and verification loop on top of the spec-grounding foundation. H1 is complete; H2–H8 are planned. See `AARCH64_AGENT_SKILL_DEV_PLAN.md` Part III for full detail.
...
| H3 | GDB-MCP debugging (step, inspect, assert registers) | 🔲 Pending |
| H4 | QEMU-AArch64 emulation automation | 🔲 Pending |
| H5 | Cross-compilation & static linking (`aarch64-linux-gnu-gcc`) | 🔲 Pending |
