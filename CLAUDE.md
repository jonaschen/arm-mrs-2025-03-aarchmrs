...
- **Phase 3 (H1–H8):** Active hardware engineering (code generation, GDB-MCP, QEMU, linter, multi-agent) — 🔲 In progress (H1–H7 complete)
...
tools/
  ...
  eval_skill.py        # [DONE] Correctness evaluation (292 tests: 51 A64 + 16 T32/A32 + 18 GIC + 24 CoreSight + 14 PMU + 14 EX + 18 H1 + 14 H3 + 23 H4 + 27 H5 + 42 H6 + 31 H7)
...
# Correctness evaluation (all 292 tests should pass)
...
H8 is the next planned milestone. It depends on H3+H4+H5 (full toolchain loop) and H7 (lint gate).
