...
- **PMU event descriptions are available.** Unlike the BSD AARCHMRS release, `pmu/*.json` data (Apache 2.0, from ARM-software/data) has real prose descriptions for every event. 31 CPU profiles are included, covering Cortex-A53 through Cortex-A725, Cortex-X1 through X925, and Neoverse E1/N1/N2/N3/V1/V2/V3/V3AE.
